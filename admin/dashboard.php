                ...
                <div class="h-full bg-white rounded-2xl dark:bg-gray-700">
                    ...
                    <nav class="mt-6">
                        <div>
                            ...
                            <a class=" <?php echo $path == 'add-quote' ? 'text-blue-500 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100': '' ?>    flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500" href="?path=add-quote">
                                <span class="text-left">
